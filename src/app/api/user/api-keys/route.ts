...
export async function POST(req: NextRequest) {
  try {
    ...
    if (apiKeys.openai !== undefined)
      updateData.openaiApiKey = apiKeys.openai ? encrypt(apiKeys.openai) : null;
    if (apiKeys.anthropic !== undefined)
      updateData.anthropicApiKey = apiKeys.anthropic
        ? encrypt(apiKeys.anthropic)
        : null;
    if (apiKeys.google !== undefined)
      updateData.googleApiKey = apiKeys.google ? encrypt(apiKeys.google) : null;
    if (apiKeys.deepseek !== undefined)
      updateData.deepseekApiKey = apiKeys.deepseek
        ? encrypt(apiKeys.deepseek)
        : null;
