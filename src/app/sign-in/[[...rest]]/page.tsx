    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      >
        <div className="space-y-8 max-w-lg w-full flex flex-col items-center md:items-start">
          ...
          >
            Experience intelligent conversations powered by advanced AI. Connect, learn, and explore with our sophisticated chat platform.
          </motion.p>
          ...
          >
            {['Intelligent', 'Secure', 'Fast', 'Intuitive'].map((tag, index) => (
              <span key={index-1} className="px-3 py-1 bg-gray-800/70 backdrop-blur-sm rounded-full text-sm text-gray-300 border border-gray-700/50">
                {tag}
              </span>
            ))}
          </motion.div>
        ...
        <div className="w-full max-w-md relative">
          ...
          <SignIn appearance={{
            elements: {
              ...
              formButtonPrimary: "bg-indigo-600 hover:bg-indigo-500 transition-all duration-200 shadow-lg hover:shadow-indigo-500/30",
              formFieldInput: "bg-gray-700/70 border-gray-600 text-white focus:border-indigo-400 focus:ring focus:ring-indigo-400/20 transition-all duration-200",
              formFieldLabel: "text-gray-300",
              headerTitle: "text-white text-2xl",
              headerSubtitle: "text-gray-400",
              footerActionText: "text-gray-400",
              footerActionLink: "text-indigo-400 hover:text-indigo-300 transition-all duration-200",
